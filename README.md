 ...
 * ADAM: Genomic Data System 0.18.1 or later, https://github.com/bigdatagenomics/adam
...
### Running adam-plugins using ```adam-submit```
    ...
    $ cp target/adam-plugins_2.10-0.18.2-SNAPSHOT.jar $ADAM_DIR
    $ cd $ADAM_DIR
...
Run plugins
    ...
    $ ./bin/adam-submit \
          --jars adam-plugins_2.10-0.18.2-SNAPSHOT.jar \
          -- \
