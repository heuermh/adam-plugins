 ...
 */
public final class JavaCountAlignmentsPerRead implements ADAMPlugin<ADAMRecord, Tuple2<CharSequence, Integer>>, Serializable {
    ...
    public RDD<Tuple2<CharSequence, Integer>> run(final SparkContext sparkContext, final RDD<ADAMRecord> recs, final String args) {
        ...
        JavaPairRDD<CharSequence, Integer> counts = contigNames.mapToPair(new PairFunction<CharSequence, CharSequence, Integer>() {
                @Override
                public Tuple2<CharSequence, Integer> call(final CharSequence readName) {
                    return new Tuple2<CharSequence, Integer>(readName, Integer.valueOf(1));
                }
            });
